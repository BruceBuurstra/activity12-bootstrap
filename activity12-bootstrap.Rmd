...
**Response**: The data seems to be clustered. The mean is about in the center which is good. The spread is not great.
...
**Response**: Probably not, many years of education have no data for them so if the mean was 11 or 14 that would not make sense.
...
13.65 to 13.83 is the 90% confidence interval. They are almost identical.
